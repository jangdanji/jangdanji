...
import getpass
isle = isletool.Isle(join(root, f"C:\\Users\\{getpass.getuser()}\\Documents\\Github\\jonathan\\rhyme_dict\\ISLEdict.txt"))
# isle = isletool.Isle()
...
print("-" * 50)
sentence2 = "there\'s he\'s it\'s that\'s what\'s let\'s bling"
