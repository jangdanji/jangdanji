...
import getpass
ret = glob.glob(f'C:\\Users\\{getpass.getuser()}\\Documents\\GitHub\\jonathan\\kkut\\data\\끄투 모든 단어 정제*')
with open(ret[0], 'rb') as f: kkutuWords = pickle.load(f)

titles = rnb_ed + bal_ed + rnb_st + bal_st + kkutuWords
